...
func AddDBMessage(pageID string, conversationID string, messageID string, timestamp int64, message string, attachment Attachment, response *FacebookResponse) error {
