...
type IGTemplateGeneric struct {
	...
	Button        []IGButton      `json:"buttons"`        // buttons shows on the template, maximum 3 buttons allow for a template
	DefaultAction IGDefaultAction `json:"default_action"` // the default action of the template
}
