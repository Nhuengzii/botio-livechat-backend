...
type DBClient interface {
	...
	UpdateConversationIsRead(ctx context.Context, shopID string, platform stdconversation.Platform, pageID string, conversationID string) error
	...
	ListConversationsOfAllPlatformsOfShop(ctx context.Context, shopID string) ([]stdconversation.StdConversation, error)
