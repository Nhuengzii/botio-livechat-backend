...
type DBClient interface {
	...
	GetPage(ctx context.Context, shopID string, platform string, pageID string) (unreadConversations []stdconversation.StdConversation, allMessages []stdmessage.StdMessage, err error)
}
