...
import (
	...
	"github.com/Nhuengzii/botio-livechat-backend/internal/fbutil/recievemsg"
...
func (l Lambda) handler(ctx context.Context, sqsEvent events.SQSEvent) {
	...
	start := time.Now()
	var recieveMessage recievemsg.RecieveMessage
...
func handleWebhookEntry(message recievemsg.Notification) error {
	return nil
}
